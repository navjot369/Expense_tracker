...
export default function Debit() {
    ...
    const handleFinalSubmit = () => {
        const curr = {title, amount, add: true, date: dateObj};
    ...
    if(isFinal) {
        return(<div className="final-outer-cont">
            <h1 className="final-heading debit-color">Debit Amount +</h1>
    ...
    return(<form className="form-outer" onSubmit={handleSubmit}>
        ...
        <button type="submit" className="submit-button bg-debit">Debit</button>
        </div>
    </form>)
}
